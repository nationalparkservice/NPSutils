...
#'
#' \code{loadAttributes} reads the metadata file from a previously downloaded package and loads a list of fields and their attributes into a data frame.
#'
...
#' @examples
#'
#' attributeTable<-loadAttributes(2266200,metadataFormat="fgdc")


loadAttributes <-function(HoldingID,dataFormat,metadataFormat){
